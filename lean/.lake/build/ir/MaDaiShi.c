...
// Module: MaDaiShi
// Imports: Init MaDaiShi.Circuit MaDaiShi.ExtendedFrege MaDaiShi.SEquivalence MaDaiShi.Padding
#include <lean/lean.h>
...
lean_object* initialize_MaDaiShi_Padding(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_MaDaiShi(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_MaDaiShi_Padding(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
